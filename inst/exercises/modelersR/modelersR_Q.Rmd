...
![Screenshot of Rstudio with the default Rmd file.](Rstudio.png){width=80%}
...
![Nicely formatted output produced from the Rmd file. Left: PDF, viewed in SumatraPDF. Middle: DOC, viewed in Microsoft Word. Right: HTML, viewed in Firefox.](Rmd_pdf_html_doc.png)
...
![Screenshot of *Rstudio* showing an R Markdown code (left) and the resulting document produced via *knit* (right).](Rmarkdown_ex1.png)
...
![Screenshot of an RTM tutorial *Reversible reactions and equilibrium chemistry*, showing the suggestions for extra exercises to solidify the knowledge gained in the tutorial.](RTMexercises.png)
