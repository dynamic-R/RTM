...
* derive relationships between the equilibrium concentrations of the state variables describing the system. \textbf{Hint:} consider that the time-derivatives of the state variables are zero when the system is in equilibrium.
