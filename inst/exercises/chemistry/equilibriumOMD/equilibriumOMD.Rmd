...
```{r child = 'equilibriumOMD_Q.Rmd'}
```

\newpage

```{r child = 'equilibriumOMD_A.Rmd'}
```
...
Andreas F. Hofmann, Karline Soetaert, Jack J. Middelburg and Filip J. R. Meysman, 2010,
  AquaEnv - An Aquatic Acid-Base Modelling Environment in R.  Aquatic Geochemistry DOI 10.1007/s10498-009-9084-1,  https://CRAN.R-project.org/package=AquaEnv
