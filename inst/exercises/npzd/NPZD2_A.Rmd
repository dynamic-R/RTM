...
<<<<<<< HEAD
![Concentual diagram of the NPZD2 model (includes bottom detritus).](NPZD2.png){width=10cm}
=======
![Concentual diagram of the NPZD2 model (includes bottom detritus)](npzd2.jpg){width=60%}
>>>>>>> GhentExamples
