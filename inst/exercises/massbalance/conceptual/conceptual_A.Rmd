...
# Exercise 5 ANSWER.	Phosphorus cycling in marine sediments

## Without iron cycling

![Conceptual scheme of a simple model of P cycling in marine sediments.](images/conceptual_Pcycling1.png){width=100%}

## With iron cycling 

![Conceptual scheme of a more realistic model of P cycling in marine sediments.](images/conceptual_Pcycling2.png){width=100%}

Note the division of the sediment column into the oxic (oxygen and nitrate are available) and anoxic (oxygen and nitrate are not available) zones.
