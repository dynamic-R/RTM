...
ini   <- find_state_pars(Vtot=Vtot.ini, Vliq=Vliq.ini, humid=humid.ini, TK=TK1)
...
ini2 <- find_state_pars(
           Vtot  = SV[["Vgas"]]*TK2/TK1 +    # gas volume changes (isobaric cooling)
