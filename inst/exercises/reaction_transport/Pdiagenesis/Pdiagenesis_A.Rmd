...
state    <- c(POC.ini, DIC.ini, PO4.ini, Pads.ini)     # note the order!
...
p1["rPads"]  <- 0      # /day    
sol1 <- steady.1D (y=state, func=PDiamodel, parms=p1, 
                   nspec=nspec, dimens=N, names=names,
                   pos=TRUE)     

p2["rPads"]  <- 1e-3   # /day   
sol2 <- steady.1D (y=state, func=PDiamodel, parms=p2, 
                   nspec=nspec, dimens=N, names=names,
                   pos=TRUE) 

p3["rPads"]  <- 5e-3   # /day      
sol3 <- steady.1D (y=state, func=PDiamodel, parms=p3, 
                   nspec=nspec, dimens=N, names=names,
                   pos=TRUE) 
```
