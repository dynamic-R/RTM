...
This latter result changes if the model is run for the sediment column depth set to $1~m$. (Not shown in this document, but try to see it for yourself.) This is understandable because by changing the length of the spatial domain, we *also* change the *boundary conditions* of the model! This highlights the importance of setting the boundary conditions so that they *realistically* represent the *in-situ* conditions of the studied system.
