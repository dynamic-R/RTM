...
question(sprintf("What is a suitable expression for the infection rate?"), type = "learnr_radio",
...
question("Foxes (F) predate on rabbits (R). What are suitable expressions for the predation rate?", type = "learnr_checkbox",
 ...
 try_again = "Multiple answers are correct. Consider Type I, II and III responses.",
 allow_retry = TRUE,
 incorrect=msg,  
 correct=msg)
```
...
msg1 <- sprintf("Note that the inhibition term is equal to one minus the Michaelis-Menten term. Thus, you can find two correct answers.")
msg2 <- sprintf("Note that the inhibition term is equal to one minus the Michaelis-Menten term. Thus, both answers 2 and 5 are correct.")
...
question("Algal N-uptake is stimulated by nitrate $(NO_3)$ and inhibited by ammonia $(NH_3)$ concentrations. What would be a suitable expression for the rate of algal growth?", type = "learnr_checkbox",
 ...
 try_again = paste("Incorrect. ", msg1),
 allow_retry = TRUE,
 incorrect=paste("Incorrect. ", msg1),  
 correct=paste("Correct. ", msg2)
)
```
...
question(sprintf("The change over time of a quantity M (in moles) is described by the differential equation (DE) $$\\frac{dM}{dt} = -r \\cdot M,$$ where $r > 0$. Which of the following statements is true?"), type = "learnr_checkbox",
 answer("this DE describes zero-order kinetics"),
 answer("this DE describes first-order kinetics", correct = TRUE),
 answer("this DE describes second-order kinetics"),
 answer("this DE is a mix of first-order and second-order kinetics"),
...
question(sprintf("The change over time of a quantity M (in moles) is described by the differential equation $$\\frac{dM}{dt} = -r \\cdot M,$$ where $r > 0$. Which of the following statements is true?"), type = "learnr_checkbox",
...
question(sprintf("The change over time of a quantity M (in moles) is described by the differential equation (DE) $$\\frac{dM}{dt} = -r,$$ where $r > 0$ is a constant. Which of the following statements is true?"), type = "learnr_checkbox",
 answer("this DE describes zero-order kinetics", correct = TRUE),
 answer("this DE describes first-order kinetics"),
 answer("this De describes second-order kinetics"),
 answer("this DE is a mix of first-order and second-order kinetics"),
 answer(sprintf("the unit of the rate constant $r$ is $day$")),
...
question(sprintf("The change over time of a quantity M (in moles) is described by the differential equation $$\\frac{dM}{dt} = -r,$$ where $r > 0$ is a constant. Which of the following statements is true?"), type = "learnr_checkbox",
...
question(sprintf("The change over time of a quantity M (in moles) is described by the differential equation (DE) $$\\frac{dM}{dt} = r \\cdot M \\cdot \\left(1-\\frac{M}{K}\\right),$$ where $r > 0$ and $K>0$ are constants. Which of the following statements is true?"), type = "learnr_checkbox",
 answer("this DE describes zero-order kinetics"),
 answer("this DE describes first-order kinetics"),
 answer("this DE describes second-order kinetics"),
 answer("this DE is a mix of first-order and second-order kinetics", correct = TRUE),
...
------------|-------------|---------------------------- | --------------------------- |
$g$         | 0.2         | uptake rate constant        |$h^{-1}$                    |
$k_s$       | 10          | half-saturation concentration    |$mol~C~m^{-3}$               |
$\gamma$    | 0.5         | bacterial growth efficiency  | -                           |
$r$         | 0.01        | basal respiration parameter |$h^{-1}$                    |
$m$         | 0.0005      | mortality rate constant         |$(mol~C~m^{-3})^{-1} h^{-1}$| 
