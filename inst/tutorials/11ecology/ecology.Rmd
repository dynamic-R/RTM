...
## Extra videos about ecological models

The following videos describe two examples of 0-dimensional ecological models solved in R.

The first model describes the spread of a virus through a population.

![](https://www.youtube.com/watch?v=eOsZzk_eN4I)

The second model describes N flow in a lake ecosystem.
...
question(sprintf("The change in time of a quantity M (in moles) is described by the differential equation $$\\frac{dM}{dt} = r \\cdot M \\cdot \\left(1-\\frac{M}{K}\\right),$$ where $r > 0$ and $K>0$. Which of the following statements is true?"), type = "learnr_checkbox",
 answer("this describes zero-order kinetics"),
 answer("this describes first-order kinetics"),
 answer("this describes second-order kinetics"),
...
To learn more about modelling of ecological interactions, solve additional exercises available in the R-package RTM. To display these exercises, enter one of the following commands in the R-console:
