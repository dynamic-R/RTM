...
To learn more about modelling of partitioning between phases, try to solve the following exercises. Note that the level of their complexity progressively increases: the first one is relatively straight-forward and you should have no problem solving it, whereas the second and third one are quite challenging. 

To display these exercises, type the following command in the R-console:
