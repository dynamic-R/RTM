...
To learn more about modelling of partitioning between phases, try to solve the following exercises. Note that the level of their complexity progressively increases. To display these exercises, type the following command in the R-console:
