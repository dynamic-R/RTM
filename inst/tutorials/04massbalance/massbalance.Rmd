...
question("Which of the following differential equations correctly describe mass balances for ammonia?", type = "learnr_checkbox",
 answer("$\\frac{d[NH_3]}{dt} = F4 + F9/h - F1 + F10 - F11$", correct=FALSE),
 answer("$\\frac{d[NH_3]}{dt} = F4 + F9 - F1 + F10 - F11$", correct=TRUE),
 answer("$\\frac{d[NH_3]}{dt} = F4 + F9 - F1 + F10/h - F11$", correct=FALSE)
)
```
...
question("Which of the following differential equations correctly describe mass balances for the DETRITUS state variable?", type = "learnr_checkbox",
 ...
 answer("$\\frac{d[DETRITUS]}{dt} = F3 + F6 + F7 + F8 - F9 - F12/h$", correct=TRUE),
 answer("$\\frac{d[DETRITUS]}{dt} = F3 + F6 - F5 + F7 + F8 - F9 - F12/h$", correct=FALSE),
 incorrect=msg, 
 correct=msg)
```
![](images/Lake_enhanced.png){width=14cm}
...
question("Which of the following differential equations correctly describe mass balances for the ammonia state variable?", type = "learnr_checkbox",
 answer("$\\frac{d[NH_3]}{dt} = F4 + F9\\cdot h - F1 + F10 - F11 + F14$", correct=FALSE),
 answer("$\\frac{d[NH_3]}{dt} = F4 + F9 - F1 + F10 - F11 + F14/h$", correct=TRUE),
 answer("$\\frac{d[NH_3]}{dt} = F4 + F9 - F1 + F10/h - F11+ F14\\cdot h$", correct=FALSE),
...
msg <- sprintf("As $R$ is expressed in $mol~{C}~m^{-3}~h^{-1}$, it is simplest to rewrite the chemical reaction for *one* mole of C reacting, i.e.: $CH_2O(NH_3)_{16/106}+\\frac{4}{5}\\cdot NO_3^- + \\frac{4}{5}\\cdot H^+ \\rightarrow CO_2 + \\frac{7}{5}\\cdot H_2O + \\frac{2}{5}\\cdot N_2 + (NH_3)_{16/106}$. This will make the mass balances clearer.")

question("Which of the following differential equations correctly describe mass balances for $OM$ in the system?", type = "learnr_checkbox",
...
```{r Denitrification1, echo=FALSE}
msg <- sprintf("As $R$ is expressed in $mol~{C}~m^{-3}~h^{-1}$, it is simplest to rewrite the chemical reaction for *one* mole of C reacting, i.e.: $CH_2O(NH_3)_{16/106}+\\frac{4}{5}\\cdot NO_3^- + \\frac{4}{5}\\cdot H^+ \\rightarrow CO_2 + \\frac{7}{5}\\cdot H_2O + \\frac{2}{5}\\cdot N_2 + (NH_3)_{16/106}$. This will make the mass balances clearer.")

question("Which of the following differential equations correctly describe mass balances for $CO_2$ in the system?", type = "learnr_checkbox",
...
question(sprintf("Which of the following differential equations correctly describe mass balances for $NO_3$ in the system?  $R$ has units of $mol\\,C\\,m^{-3}\\,h^{-1}$."), type = "learnr_checkbox",
...
```{r Denitrification3, echo=FALSE}
msg <- sprintf("As $R$ is expressed in $mol~{C}~m^{-3}~h^{-1}$, it is simplest to rewrite the chemical reaction for *one* mole of C reacting, i.e.: $CH_2O(NH_3)_{16/106}+\\frac{4}{5}\\cdot NO_3^-+\\frac{4}{5}\\cdot H^+ \\rightarrow CO_2+\\frac{7}{5}\\cdot H_2O+\\frac{2}{5}\\cdot N_2+(NH_3)_{16/106}$. Then, the mass balances are clearer.")

question(sprintf("Which of the following differential equations correctly describe mass balances for $NH_3$ in the system?  $R$ has units of $mol~{C}~m^{-3}~h^{-1}$."), type = "learnr_checkbox",
...
```{r Denitrification4, echo=FALSE}
msg <- sprintf("As $R$ is expressed in $mol~{C}~m^{-3}~h^{-1}$, it is simplest to rewrite the chemical reaction for *one* mole of C reacting, i.e.: $CH_2O(NH_3)_{16/106}+\\frac{4}{5}\\cdot NO_3^-+\\frac{4}{5}\\cdot H^+ \\rightarrow CO_2+\\frac{7}{5}\\cdot H_2O+\\frac{2}{5}\\cdot N_2+(NH_3)_{16/106}$. Then, the mass balances are clearer.")

question(sprintf("Which of the following differential equations correctly describe mass balances for $N_2$ in the system?  $R$ has units of $mol~{C}~m^{-3}~h^{-1}$, $N_2$ has units of $mol~{N_2}~m^{-3}$."), type = "learnr_checkbox",
...
```{r Denitrification5, echo=FALSE}
msg <- sprintf("As $R$ is expressed in $mol~{C}~m^{-3}~h^{-1}$, it is simplest to rewrite the chemical reaction for *one* mole of C reacting, i.e.: $CH_2O(NH_3)_{16/106}+\\frac{4}{5}\\cdot NO_3^-+\\frac{4}{5}\\cdot H^+ \\rightarrow CO_2+\\frac{7}{5}\\cdot H_2O+\\frac{2}{5}\\cdot N_2+(NH_3)_{16/106}$. Then, the mass balances are clearer.")

question(sprintf("Which of the following differential equations correctly describe mass balances for $N_2$ in the system if the units of $R$ remain equal to $mol~{C}~m^{-3}~h^{-1}$ but $N_2$ is expressed in $mol~{N}~m^{-3}$."), type = "learnr_checkbox",
 answer("$\\frac{d[N_2]}{dt} = 2\\cdot R$", correct=FALSE),
 answer("$\\frac{d[N_2]}{dt} = \\frac{2}{5}\\cdot R$", correct=FALSE),
 answer("$\\frac{d[N_2]}{dt} = \\frac{4}{5}\\cdot R$", correct=TRUE),
 answer("$\\frac{d[N_2]}{dt} = 4\\cdot R$", correct=FALSE),
 answer("$\\frac{d[N_2]}{dt} = R$", correct=FALSE),
 answer("$\\frac{d[N_2]}{dt} = \\frac{1}{2}\\cdot R$", correct=FALSE),
