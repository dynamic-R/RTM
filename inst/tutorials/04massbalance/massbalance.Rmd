...
question(sprintf("Which of the following differential equations correctly describe mass balances for the system?  $R$ has units of $mol~C~m^{-3}~h^{-1}$."), type = "learnr_checkbox",
 ...
 answer("$\\frac{d[NO3]}{dt} = 4\\cdot R$", correct=FALSE),
 answer("$\\frac{d[NO3]}{dt} = -\\frac{4}{5}\\cdot R$", correct=TRUE),
 answer("$\\frac{d[NO3]}{dt} = -\\frac{5}{4}\\cdot R$", correct=FALSE),
 answer("$\\frac{d[NH3]}{dt} = -5\\cdot R$", correct=FALSE),
 answer("$\\frac{d[NH3]}{dt} = 5\\cdot R$", correct=FALSE),
 answer("$\\frac{d[NH3]}{dt} = \\frac{16}{106}\\cdot R$", correct=TRUE),
 answer("$\\frac{d[NH3]}{dt} = -\\frac{16}{106}\\cdot R$", correct=FALSE),
 answer("$\\frac{d[NH3]}{dt} = 5\\cdot \\frac{16}{106}\\cdot R$", correct=FALSE),
 answer("$\\frac{d[NH3]}{dt} = -\\frac{106}{16}\\cdot R$", correct=FALSE),
 answer("$\\frac{d[N2]}{dt} = 2\\cdot R$", correct=FALSE),
 answer("$\\frac{d[N2]}{dt} = \\frac{2}{5}\\cdot R$", correct=TRUE),
 answer("$\\frac{d[N2]}{dt} = \\frac{4}{5}\\cdot R$", correct=FALSE),
 answer("$\\frac{d[N2]}{dt} = 4\\cdot R$", correct=FALSE),
 answer("$\\frac{d[N2]}{dt} = R$", correct=FALSE),
 answer("$\\frac{d[N2]}{dt} = \\frac{1}{2}\\cdot R$", correct=FALSE),
