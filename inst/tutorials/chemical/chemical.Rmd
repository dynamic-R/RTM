...
msg <- "There are two correct answers; answer 1 assumes that the rate R is expressed in mole of B per time; answer 4 assumes that R is expressed in mole of A per time - it is simplest to express the rate in terms of mole of B"
...
plot(out, out2, out3, lty=1:3, col=1:3)
```
