...
std <- steady.1D (y=Conc, func=PDiamodel, parms=pD, 
...
std.fun <- function(pars){
  std <- steady.1D (y=Conc, func=PDiamodel, parms=pars, nspec=nspec, dimens=N, 
...
std2 <- steady.1D(y=Conc, func=PDiamodel, parms=pD2, 
                  nspec=nspec, dimens=N, names=names,
                  pos=TRUE)     
