...
Here, we describe a newly developed R-package RTM. This package merges four main components of the teaching material --- tutorials, exercises, template files, and extra readers --- into a common platform. First, we discuss how the flipped modelling class is implemented. Then, we provide examples that illustrate how the RTM package can be used to deliver the teaching material to students and thus aid their learning experience. 
